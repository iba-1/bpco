...
Il backend (Postgres gestito, object storage, VM con docker compose) è ospitato su **Exoscale** (Svizzera, ISO 27001, SOC 2, giurisdizione adeguata all'UE) invece che su un hyperscaler US o su un provider US con region EU.
